...
cp "/rds/general/user/rk820/home/dibs-g16/fc_ht/project/Phenanthrene/./Phenanthrene_n_linked1.gjf" ./

#convert old checkpoints to latest (i.e. for g03 checkpoints generated before ~Dec 2009)
#c8609 "Phenanthrene_n_linked1.chk"

# no more pbsexec... running directly.
g16 Phenanthrene_n_linked1.gjf
