...
#PBS -l select=1:ncpus=128:mem=919GB

module load "gaussian/g16-c01-avx2" 
cp "/rds/general/user/rk820/home/dibs-g16/fc_ht/project/./Perylene_linked1.gjf" ./

#convert old checkpoints to latest (i.e. for g03 checkpoints generated before ~Dec 2009)
#c8609 "Perylene_linked1.chk"

# no more pbsexec... running directly.
g16 Perylene_linked1.gjf
