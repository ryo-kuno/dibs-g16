...
cp "/rds/general/user/rk820/home/dibs-g16/fc_ht/project/Naphthalene/./Naphthalene_n_linked2.gjf" ./

#convert old checkpoints to latest (i.e. for g03 checkpoints generated before ~Dec 2009)
#c8609 "Naphthalene_n_linked2.chk"

# no more pbsexec... running directly.
g16 Naphthalene_n_linked2.gjf
