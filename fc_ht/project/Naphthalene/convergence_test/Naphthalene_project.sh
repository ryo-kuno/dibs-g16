...
cp "/rds/general/user/rk820/home/dibs-g16/fc_ht/project/Naphthalene/convergence_test/./Naphthalene_project.gjf" ./

#convert old checkpoints to latest (i.e. for g03 checkpoints generated before ~Dec 2009)
#c8609 "Naphthalene_project.chk"

# no more pbsexec... running directly.
g16 Naphthalene_project.gjf
