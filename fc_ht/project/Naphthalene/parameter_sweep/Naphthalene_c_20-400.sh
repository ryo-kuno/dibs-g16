...
cp "/rds/general/user/rk820/home/dibs-g16/fc_ht/project/Naphthalene/parameter_sweep/./Naphthalene_c_20-400.gjf" ./

#convert old checkpoints to latest (i.e. for g03 checkpoints generated before ~Dec 2009)
#c8609 "Naphthalene_c_20-400.chk"

# no more pbsexec... running directly.
g16 Naphthalene_c_20-400.gjf
